...
const DEFAULT_CONFIG = {
  spaces: {},
  default_spaces: [],
  // Set this to the URL prefix of your team's issue tracker, e.g.
  // "redmine.example.com/issues/" or "github.com/your-org/your-repo/issues/".
  // The matcher captures the issue id (\d+) that immediately follows.
  redmine_url_pattern: "",
